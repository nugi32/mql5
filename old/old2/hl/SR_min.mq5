...
input ENUM_TIMEFRAMES SourceTF = PERIOD_CURRENT;
 bool ShowHistorical = true;           // Tampilkan garis historis
 color ResistanceColor = clrLime;      // Warna resistance
 color SupportColor = clrRed;          // Warna support
 int LineWidth = 1;                    // Ketebalan garis
 ENUM_LINE_STYLE LineStyle = STYLE_SOLID; // Gaya garis
