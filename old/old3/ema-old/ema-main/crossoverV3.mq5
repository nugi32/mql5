...
//================ GLOBAL =================
int fastEmaHandle, slowEmaHandle, sidewaysHandle, sidewaysEmaFastHandle, sidewaysEmaSlowHandle;
int sarHandle, atrHandle;

double atrBuffer[];
double fastEma[], slowEma[], sidewaysBuffer[], sidewaysEmaFast[], sidewaysEmaSlow[];
MqlRates rates[];
